        ...
        <>
            {props.type === "edit"
                ...
                <div className="DAT_RolePopup">
                    <div className="DAT_RolePopup_Head">
                        <div className="DAT_RolePopup_Head_Left">
                            {dataLang.formatMessage({ id: "edits" })}
                        </div>

                        <div className="DAT_RolePopup_Head_Right">
                            <div
                                className="DAT_RolePopup_Head_Right_Icon"
                    ...
                    <div className="DAT_RolePopup_Body">
                        <div className="DAT_RolePopup_Body_Row">
                            <div className="DAT_RolePopup_Body_Row_Left">
                        ...
                        <div className="DAT_RolePopup_Body_Row" style={{ marginBottom: "0px" }}>
                            <div className="DAT_RolePopup_Body_Row_Left">
                                <span style={{ color: "red" }}>* </span>
                    ...
                    <div className="DAT_RolePopup_Foot">
                        <button
