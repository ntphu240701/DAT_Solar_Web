...
export const messages = {
    en: {
        ...
        accountLockAlert: 'Your account is currently locked. Please contact the administrator to reactivate it!',
    ...
    vi: {
        ...
        delWarn: 'Xóa cảnh báo',
        delWarnmess: 'Bạn có chắc muốn xóa cảnh báo này không?',
